...
exports.IGNORED_PROPERTIES = exports.IGNORED_USERS = void 0;
 ...
 */
exports.IGNORED_USERS = ['user', 'gitpod', 'theia', 'vscode', 'redhat'];
exports.IGNORED_PROPERTIES = ['extension_name', 'extension_version', 'app_name', 'app_version', 'app_kind', 'app_remote', 'app_host', 'browser_name', 'browser_version', ''];
function transform(event, userId, environment) {
...
function sanitize(properties, environment) {
    ...
    for (const p in properties) {
        ...
        if (!rawProperty || exports.IGNORED_PROPERTIES.includes(p) || !usernameRegexp || isNonStringPrimitive(rawProperty)) {
