...
exports.RedHatServiceWebWorkerProvider = void 0;
...
const vfsIdManager_1 = require("./vfsIdManager");
const eventCacheService_1 = require("../common/impl/eventCacheService");
class RedHatServiceWebWorkerProvider extends redhatServiceInitializer_1.AbstractRedHatServiceProvider {
    async buildRedHatService() {
        ...
        const idManager = new vfsIdManager_1.VFSSystemIdProvider(storageService);
...
exports.RedHatServiceWebWorkerProvider = RedHatServiceWebWorkerProvider;
//# sourceMappingURL=redHatServiceWebWorkerProvider.js.map